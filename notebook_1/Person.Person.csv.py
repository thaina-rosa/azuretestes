...
#pegando arquivos 
df = spark.read.option("header", "true").option("inferSchema", "true").option("delimiter", ";").csv("/mnt/blobthai/Person.Person.csv")
...
dfp.loc[dfp['Title'] == 'NULL', 'Title'] = 'NaoInformado'

# COMMAND ----------

dfp.loc[dfp['Suffix'] == 'NULL', 'Suffix'] = 'NaoInformado'

# COMMAND ----------

dfp.loc[dfp['MiddleName'] == 'NULL', 'MiddleName'] = 'NaoInformado'

# COMMAND ----------

dfp.loc[dfp['AdditionalContactInfo'] == 'NULL', 'AdditionalContactInfo'] = 'NaoInformado'
...
dft = dfs.withColumn("ModifiedDate",
