...
#pegando arquivos 
df = spark.read.option("header", "true").option("inferSchema", "true").option("delimiter", ";").csv("/mnt/blobthai/Sales.SalesOrderDetail.csv")
...
dfp.loc[dfp['CarrierTrackingNumber']=="NULL",'CarrierTrackingNumber']= "NaoInformado"
...
dfc= dfs.withColumn("ModifiedDate",
